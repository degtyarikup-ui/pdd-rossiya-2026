...
- Веб RU — два сайта:
  - **Лендинг + блог** (SEO): исходники `web_landing/ru/` (чистая статика,
    ...
    - **Скриншоты приложения** (мокапы для сайта): `tools/blog_admin/gen_images.py`
      ...
      статей.
    - **Иллюстрации блога** (правила генерации):
      1. Формат обложек — строго 16:9 (1200×630 / 1200×675), идеально встающий в разметку OpenGraph и шапку статьи.
      2. Персонажи — только приятной славянской внешности (под контекст ПДД РФ).
      3. Обстановка — чистая, современная, эстетичная (никакой разрухи, старых интерьеров или грязных дорог).
      4. Дорожные знаки, светофоры и разметка — строго по ГОСТ РФ (знак «У», разметка 1.1–1.26, российские светофоры).
      5. Стилистика — живая реалистичная съёмка, без стокового глянца и без типичного «AI-слопа»/артефактов.
      6. Иллюстрации внутри статей — уместные тематические схемы/фото (16:9) для наглядности сложных моментов.
