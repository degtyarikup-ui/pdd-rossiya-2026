...
void main() {
          ...
          home: Scaffold(
            body: Builder(
              builder: (context) => ElevatedButton(
                onPressed: () =>
                    PremiumGrantedDialog.show(context, expiresAt: exp),
  ...
  testWidgets(
    'PremiumGrantedDialog displays correct elements for lifetime duration',
    (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: Builder(
              builder: (context) => ElevatedButton(
                onPressed: () =>
                    PremiumGrantedDialog.show(context, expiresAt: null),
                child: const Text('Open'),
              ),
            ),
          ),
      ...
      expect(find.text('Вам выдан Premium!'), findsOneWidget);
      expect(
        find.text('Вам открыт бессрочный доступ навсегда!'),
        findsOneWidget,
      );
    },
  );
