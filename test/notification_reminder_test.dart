...
void main() {
  group('computeStreakReminderTime', () {
    ...
    test(
      'серия активна, сегодня НЕ тренировался, до 20:00 → сегодня 20:00',
      () {
        final now = DateTime(2026, 7, 17, 15);
    ...
    test(
      'серия активна, НЕ тренировался, но уже позже 20:00 → завтра 20:00',
      () {
    ...
    test(
      'ровно 20:00 и не тренировался → завтра (окно на сегодня закрыто)',
      () {
